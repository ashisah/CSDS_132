 ...
 * Represents an element of double linked list (it's basically a wrapper class for another object)
 * Can have two connections, one to a node that comes before it and another to a node that comes after it
